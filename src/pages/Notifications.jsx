...
const Notifications = () => {
  ...
  return (
    <main className="h-screen min-h-screen w-screen gap-5 relative flex flex-col md:items-start items-center md:flex-row bg-mint-cream font-roboto">
      ...
      <section className="flex flex-col justify-center items-center w-full px-2 gap-10 md:py-10">
        ...
        <div className="flex flex-col justify-center items-center w-full max-w-lg px-2 gap-3">
          {friendRequests.length > 0 ? (
            ...
            <h1 className="text-ash-grey"> You have no friends requests yet</h1>
          )}
        </div>
      </section>
    </main>
